...
import demoImage from "../../public/assets/Images/demo.jpg";
    ...
    <React.Fragment>
      <CardContent className="dashboard-card-content">
        <Box className="card-content-main-box">
          <Box className="card-content-icon-div card-content-icon-div-background">
            <SchoolIcon sx={{ color: "#4c8af6" }} />
          </Box>
        </Box>
        <Box>
          <Typography className="total-text">Total Students</Typography>
          <Typography className="total-text-count">{studentCount}</Typography>
        </Box>
      </CardContent>
    </React.Fragment>
  );
  ...
  const card2 = (
    <React.Fragment>
      <CardContent className="dashboard-card-content">
        ...
        <Box>
          <Typography className="total-text">Total Professors</Typography>
          <Typography className="total-text-count">{professorCount}</Typography>
        </Box>
      </CardContent>
    </React.Fragment>
  );
  ...
  const card3 = (
    <React.Fragment>
      <CardContent className="dashboard-card-content">
        ...
        <Box>
          <Typography className="total-text">Total Students</Typography>
          <Typography className="total-text-count">2500</Typography>
        </Box>
      </CardContent>
    </React.Fragment>
  );
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Box className="dashboard-Attendance-header">
      ...
      >
        ...
        >
          <Box className="board-header-div">
            <h3>Notice Board</h3>
            <button
          ...
          <Box className="board-main-content-div">
            {notices.map((notice) => (
