...
import { CallAPI, CallAPIForFileUpload } from "../../pages/apiCall/callApi";
    ...
    >
      ...
      <DialogContent dividers>
        ...
        <Box sx={{ display: "flex", gap: 3 }}>
          ...
          <Box>
            Mobile
            <Typography sx={{ fontWeight: "600" }}>{initialData?.mobileNumber}</Typography>
          </Box>
        </Box>
        <Divider sx={{ my: 2, border: 1 }} variant="middle" />
        <Box sx={{ display: "flex", gap: 3 }}>
