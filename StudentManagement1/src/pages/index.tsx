...
import SignInImage from "../../public/assets/Images/signin-image.jpg";
import LogoImage from "../../public/assets/Images/logo2.svg";
import * as Yup from "yup";
import { useFormik } from "formik";
import { CallLoginAPI } from "./apiCall/callApi";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src={SignInImage} alt="signin-img" />
        </Box>
        <Box
          sx={{
            display: "flex",
